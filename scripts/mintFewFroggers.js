...
async function main() {
  const contractAddress = "0x9d895Be7d481CCA2B4BFc03885Eb95d53FfCEa43"; // ← Adresse deines Froggers01-Vertrags auf Polygon
  const recipient = "0x2903d58C2ABb9737D44031176A8C69d60ee310E4";     // ← Zieladresse fürs Minting
  ...
  for (let i = 0; i < quantity; i++) {
    ...
    console.log(`🧭 OpenSea: https://opensea.io/assets/matic/${contractAddress}/${i}`);
  }
}
