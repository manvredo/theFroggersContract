...
export default function Home() {
  ...
  const salePhase: SalePhase = presaleActive
    ? 'presale'
    : publicSaleActive
    ? 'public'
    : 'presale'
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-6 bg-glibberGray text-white font-sans">
      ...
      <div className="bg-white text-glibberGray p-6 rounded shadow w-full max-w-md mb-8">
        ...
        <button
          onClick={handleMint}
          disabled={isPending || (salePhase === 'presale' && !whitelisted)}
        ...
        {minted && (
          <div className="mt-6 text-center space-y-4">
            ...
            {revealed ? (
              ...
              <button
                onClick={() =>
                  alert('👁️ Reveal ist noch nicht aktiviert. Die Froggers glibbern noch unter der Oberfläche!')
                }
